...
(function() {
    ...
    var IEventHandler = {
        ...
        forwardEvent: function(sGisEvent) {
            ...
            if (this._eventHandlers && this._eventHandlers[eventType]) {
                var handlerList = this._eventHandlers[eventType].concat(); //This is needed in case one of the handlers is deleted in the process of handling
        ...
        addListener: function(description, handler) {
            ...
            //if (!utils.isString(description)) utils.error('String is expected but got ' + description + ' instead'); TODO
    ...
    if (typeof define === 'function' && define.amd) {
        define(function() { return IEventHandler; });
